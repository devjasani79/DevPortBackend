...
-- Step 1: Check if profiles table exists and has the correct structure
-- If profiles table doesn't exist or has wrong structure, create/fix it
...
-- Drop profiles table if it exists (this will cascade delete customers and shippers)
DROP TABLE IF EXISTS profiles CASCADE;

-- Recreate profiles table with correct foreign key to auth.users
...
-- Update shipment_requests table to reference customers correctly
